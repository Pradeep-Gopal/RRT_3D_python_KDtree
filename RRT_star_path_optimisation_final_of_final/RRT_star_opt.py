...
#     a = b = c = d = e = f = g = h = 0
#     if(1.75 <= i <=3.25) and (2.75 <= j <= 4.25) and (0 <= k <= 10):
#         a = 1
#     elif (3.75 <= i <=5.25) and (0.75 <= j <= 2.25) and (0 <= k <= 10):
#         b = 1
#     elif (5.75 <= i <=7.25) and (4.75 <= j <= 6.25) and (0 <= k <= 10):
#         c = 1
#     elif (7.75 <= i <=9.25) and (2.75 <= j <= 4.25) and (0 <= k <= 10):
#         d = 1
#     elif (8.75 <= i <=10.25) and (6.75 <= j <= 8.25) and (0 <= k <= 10):
#         e = 1
#     elif (1.75 <= i <=3.25) and (6.75 <= j <= 8.25) and (0 <= k <= 10):
#         f = 1
#     elif (4.75 <= i <=6.25) and (3.75 <= j <= 5.25) and (0 <= k <= 10):
#         g = 1
#     elif (8.75 <= i <=10.25) and (5.75 <= j <= 7.25) and (0 <= k <= 10):
#         h = 1
...
def obstacle_check(i,j,k):
    a = b = c = d = e = f = g = h = 0
    if(2-c <= i <=3+c) and (3-c <= j <= 4+c) and (0 <= k <= 10):
        a = 1
    elif (4-c <= i <=5+c) and (1-c <= j <= 2+c) and (0 <= k <= 10):
        b = 1
    elif (6-c <= i <=7+c) and (5-c <= j <= 6+c) and (0 <= k <= 10):
        c = 1
    elif (8-c <= i <=9+c) and (3-c <= j <= 4+c) and (0 <= k <= 10):
        d = 1
    elif (6-c <= i <=7+c) and (7-c <= j <= 8+c) and (0 <= k <= 10):
        e = 1
    elif (2-c <= i <=3+c) and (7-c <= j <= 8+c) and (0 <= k <= 10):
        f = 1
    elif (4-c <= i <=5+c) and (4-c <= j <= 5+c) and (0 <= k <= 10):
        g = 1
    elif (9-c <= i <=10+c) and (6-c <= j <= 7+c) and (0 <= k <= 10):
        h = 1
...
def obstacle_map():
    ...
    dz = [10,10,10,10,10,10,10,10]   # height of bar 
...
def goalcheck_circle(x, y, z, goal_x, goal_y, goal_z):
    if ((x - goal_x) ** 2 + (y - goal_y) ** 2 + (z - goal_z) **2 <= (0.25 ** 2)):
        return True
    else:
        return False
            ...
            for nei in n:
                ...
                if nei != parent:
                    ...
                    if cost_dict[nei] > (cost_dict[s] + cost2go(s, nei)):
                        print("reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeewired")
                        parent_dict[nei] = s
